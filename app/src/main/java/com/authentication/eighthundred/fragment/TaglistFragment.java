...
import com.authentication.eighthundred.activity.BaseUHFActivity;
...
public class TaglistFragment extends ListFragment {
	...
	private TagReadFragment objFragment;
	private TagWriteFragment objWriteFragment;
	...
	public void clearItem() {
		...
		objFragment = (TagReadFragment) fragmentManager
				.findFragmentById(R.id.fragment_tagRead);
		if(objFragment==null){
			objFragment=new TagReadFragment();
		}
		objWriteFragment = (TagWriteFragment) fragmentManager
				.findFragmentById(R.id.fragment_tagWrite);
		if(objWriteFragment==null){
			objWriteFragment=new TagWriteFragment();
		}
		TextView txtEpc = (TextView) objFragment.getActivity().findViewById(
				R.id.txtReadEpc);
		TextView txtWriteEpc = (TextView) objWriteFragment.getActivity()
