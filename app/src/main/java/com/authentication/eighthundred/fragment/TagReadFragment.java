...
public class TagReadFragment extends Fragment {
	...
	private void read() {
		...
		if(!TextUtils.isEmpty(data)){
			ToastUtil.showToast(getActivity(), getActivity().getResources().getString(R.string.read_card_success));
		}else{
			ToastUtil.showToast(getActivity(), getActivity().getResources().getString(R.string.read_card_fail));
		}
	}
