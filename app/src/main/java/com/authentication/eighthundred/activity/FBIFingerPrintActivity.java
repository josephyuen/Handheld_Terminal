...
import com.authentication.eighthundred.bean.FBIFingerModel;
import com.authentication.utils.DataUtils;
import com.authentication.utils.FingerDBOperation;
import com.authentication.utils.FingerId;
	...
	private Handler mHandler = new Handler() {
		public void handleMessage(Message aMsg) {
			...
			case FBIFingerPrintAPI.GET_FINGER_TEMPLATE_ISO:
				Log.d("jokey", "GET_FINGER_TEMPLATE_ISO");
	...
	private void verify() {
		...
		if(TextUtils.isEmpty(id)){
			...
			if(fingers.size()>0){
				...
				ToastUtil.showToast(getApplicationContext(), "No fingers with this ID!");
		}
	}
	/**
