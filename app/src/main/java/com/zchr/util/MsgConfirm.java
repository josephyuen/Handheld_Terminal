...
import com.authentication.eighthundred.activity.DebitCreditTransReadCardActivity;
...
public class MsgConfirm extends Dialog {
	...
	public void onBackPressed() {
		DebitCreditTransReadCardActivity.setM_iProcState(0);
		DebitCreditTransReadCardActivity.setScreenShow(255, 2, mContext.getResources().getString(R.string.card_read_fail), ScreenShowInfo.SCREEN_SHOW_ALIGN_CENTER);
		super.onBackPressed();
	}
